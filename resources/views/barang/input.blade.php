                ...
                <div class="card p-3">
                    <form action="{{url('/barang/add')}}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{old('namabarang')}}" class="form-control {{ $errors->get('namabarang') ? 'is-invalid'  : ''}}"
                                id="exampleInputbarang" name="namabarang">
                        </div>
                        <div class="mb-3">
                            <label for="idsatuan" class="form-label">Satuan</label>
                            <select class="form-select  {{ $errors->get('idsatuan') ? 'is-invalid'  : ''}}" name="idsatuan" aria-label="Default select example">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{old('stok')}}" class="form-control  {{ $errors->get('stok') ? 'is-invalid'  : ''}}"
                                id="exampleInputstok" name="stok">
                        </div>
                        <div class="mb-3">
                            <label for="lokasi" class="form-label">Lokasi</label>
                            <textarea class="form-control  {{ $errors->get('lokasi') ? 'is-invalid'  : ''}}" name="lokasi" id="exampleFormControlTextarea1" rows="3" >
                                {{old('lokasi')}}
                            </textarea>
                        </div>
                        <div class="mb-3">
